...
if("TRUE" STREQUAL "TRUE")
  set(S_SOURCE_PREFIX /home/amov/catkin_ws/src/S)
  set(S_DEVEL_PREFIX /home/amov/catkin_ws/devel/.private/S)
  set(S_INSTALL_PREFIX "")
  set(S_PREFIX ${S_DEVEL_PREFIX})
else()
  set(S_SOURCE_PREFIX "")
  set(S_DEVEL_PREFIX "")
  set(S_INSTALL_PREFIX /home/amov/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'S' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/amov/catkin_ws/src/S/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT S_NUM_DUMMY_TARGETS)
      set(S_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::S::wrapped-linker-option${S_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR S_NUM_DUMMY_TARGETS "${S_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::S::wrapped-linker-option${S_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND S_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/amov/catkin_ws/devel/.private/S/lib;/home/amov/catkin_ws/devel/lib;/home/amov/VINS_FUSION/devel/lib;/home/amov/amovlab_ws/devel/lib;/home/amov/rplidar_ws/devel/lib;/home/amov/Prometheus/devel/lib;/home/amov/realsense_ws/devel/lib;/opt/ros/melodic/lib)
